...
void blocking_write_sector(SectorDescriptor sd, Voucher *v){
    printf("HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH");
    sleep(1);
    printf("HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH");
}
int nonblocking_write_sector(SectorDescriptor sd, Voucher *v){return 0;}
...
int nonblocking_read_sector(SectorDescriptor sd, Voucher *v){return 0;}
